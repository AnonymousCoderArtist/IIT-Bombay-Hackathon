...
const en = {
  ...
  "hero.subtitle":
    "Attendance, assignments, events and placements. One fast, secure platform for students, faculty and coordinators.",
...
const hi: Record<MessageKey, string> = {
  ...
  "hero.subtitle":
    "उपस्थिति, असाइनमेंट, इवेंट, प्लेसमेंट और क्लब. स्टूडेंट्स, फैकल्टी और कोऑर्डिनेटर्स के लिए एक तेज़, सुरक्षित और सुंदर प्लेटफॉर्म।",
