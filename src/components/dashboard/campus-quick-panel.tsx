          ...
          <div className="mt-4 space-y-2">
            {points.map((point, i) => (
              <Link
                ...
                href={point.href}
                className={cn(
                  "group flex items-center justify-between rounded-xl border border-border/60 bg-background/40 px-3.5 py-2.5 text-sm font-medium transition-all duration-200",
